...
public class Home extends javax.swing.JFrame {
    ...
    // If it's a number, create the Song object
    Song newSong = new Song(title, artist, album,lengthInt);
    likedPlaylist.addSong(newSong);
    refreshGui();
} catch (NumberFormatException e) {
    // If it's not a number, send an alert to the user
    JOptionPane.showMessageDialog(null, "Please enter a number for the length.", "Invalid Input", JOptionPane.ERROR_MESSAGE);
}
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        switch (keepsTrackOfWhichClassPlaying) {
            case 0:
                break;
            case 1:
                genre1.skip();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        keepsTrackOfWhichClassPlaying = 1;
         genre1.setPause(true);
        genre1.setPause(false);
        genre1.setList(genre1.getArraylist());
        genre1.play();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        keepsTrackOfWhichClassPlaying = 2;
        
        genre2.setPause(true);
        genre2.setPause(false);
        genre1.setList(genre2.getArraylist());
        genre2.play();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
     ...
     public void changeSongDuration(String num){
        seconds = num;
        revalidate();
        repaint();
    }
     void changeSongNamePlaying(String name){
         songPlaying = name;
    }
    /**
    ...
    private static int keepsTrackOfWhichClassPlaying = 0;
